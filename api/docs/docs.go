...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/dishes/recommendations/{user_id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Dish informations",
                        "schema": {
                            "$ref": "#/definitions/dish.Recommendations"
                        }
                    },
                    "400": {
                        "description": "Invalid inputs can result to ",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/order.ReqCreateOrder"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of kitchens",
                        "schema": {
                            "$ref": "#/definitions/order.KitchenStatistics"
                        }
                    },
                    "400": {
                        "description": "Invalid inputs",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Profile informations",
                        "schema": {
                            "$ref": "#/definitions/user.PreferencesRes"
                        }
                    },
                    "400": {
                        "description": "Invalid inputs can result to ",
        ...
        "order.KitchenStatistics": {
            ...
            "properties": {
                ...
                "busiest_hours": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/order.HourStats"
                    }
                },
                "top_dishes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/order.DishStats"
                    }
                },
                "total_orders": {
                    "type": "integer"
